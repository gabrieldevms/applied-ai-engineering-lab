...
This document preserves the detailed technical inventory of the Applied AI Engineering Lab and the AI Quality Command Center.

The main `README.md` is optimized as a portfolio landing page. This reference document keeps the more complete capability-by-capability description, API inventory, implementation notes, current limitations and milestone details.

Use this document when you want a deeper technical view of what is implemented in the project.
